...
def process_song_file(cur, filepath):
    ...
    Process song file and load song and artist.
    
    :param cur: the cursor.
    :param filepath: the absolute path to song file.
    """
    # open song file
    print(filepath)
...
def process_log_file(cur, filepath):
    ...
    Process log file and load time, user and songplay.
    
    :param cur: the cursor.
    :param filepath: the absolute path to log file.
    """
    # open log file
    df = pd.read_json(filepath, lines=True)
...
def process_data(cur, conn, filepath, func):
    ...
    Process song file adding songs and artists to songs and artists tables.
    
    :param cur: the cursor.
    :param conn: the connection object.
    :param filepath: the folder path.
    :param func: the method to be used to process the data.
    """
